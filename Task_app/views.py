...
def urnp(request):
	if request.method=="POST":
		...
		try:
			...
			print(pw)
			subject= "New Password Request Message By TaskApp."
			msg ="Your New Password For Registration is " + str(pw)
			host='taskapp7@gmail.com'
			recepient=[em]
			...
			return render(request, "urnp.html",{"msg":"email is not registered"})
	else:
